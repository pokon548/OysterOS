    ...
    fontconfig = {
      ...
      localConf = ''
        ...
        <fontconfig>
          ...
          <!-- This adds Twitter Color Emoji as a final fallback font for the default font families. -->
          <match target="pattern">
          ...
          <!-- Use Twitter Color Emoji when other popular fonts are being specifically requested. -->
          <match target="pattern">
          ...
          <!-- 英文默认字体使用 Sarasa Gothic SC ,终端使用 Sarasa Mono SC. -->
          <match>
          ...
          <!-- 中文默认字体使用更纱黑体和霞鹜文楷,不使用　Noto Sans CJK SC 是因为这个字体会在特定情况下显示片假字. -->
          <match>
          ...
          <!-- 把所有常见的中文字体映射到更纱黑体和霞鹜文楷，这样当这些字体未安装时会使用更纱黑体和思源宋体.
